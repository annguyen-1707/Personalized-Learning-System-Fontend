      ...
      <div className="space-y-4">
        {reminders.map(reminder => (
          <motion.div
            ...
            className={`p-4 rounded-lg border ${reminder.active ? 'border-primary-200 bg-primary-50' : 'border-gray-200 bg-gray-50'
              }`}
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                <FiClock className={`mr-2 ${reminder.active ? 'text-primary-500' : 'text-gray-400'
                  }`} />
                <span className={`text-lg font-medium ${reminder.active ? 'text-gray-900' : 'text-gray-500'
                  }`}>
                  {reminder.time}
                </span>
              </div>
