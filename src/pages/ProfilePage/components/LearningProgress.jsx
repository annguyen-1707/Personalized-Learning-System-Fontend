    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500">487 words learned</p>
        </div>
        
        <div className="flex flex-col items-center">
          <div className="w-24 h-24 mb-4">
            <CircularProgressbar
              value={progress.grammar}
              text={`${progress.grammar}%`}
              styles={buildStyles({
                textSize: '20px',
                pathColor: '#FF9F43',
                textColor: '#FF9F43',
          ...
          <p className="text-sm text-gray-500">64 points mastered</p>
        </div>
        
        <div className="flex flex-col items-center">
          <div className="w-24 h-24 mb-4">
            <CircularProgressbar
              value={progress.exercises}
              text={`${progress.exercises}%`}
              styles={buildStyles({
                textSize: '20px',
                pathColor: '#38A169',
                textColor: '#38A169',
          ...
          <p className="text-sm text-gray-500">32 quizzes completed</p>
        </div>
      </div>
    </motion.div>
  )
