...
function NewsImg({ image, title, code, onClick }) {
    const showImage = (image) => {
        console.log("Show image:", image);
        window.open("http://localhost:8080/images/content_reading/" + image, "_blank");
    };
    return (
        <div className="relative">
            <img
                ...
                src={
                    image
                        ? "http://localhost:8080/images/content_reading/" + image
